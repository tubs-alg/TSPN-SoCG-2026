...
benchmark = benchmark.sort_values(by=["decomposition"])
print(
    "loaded",
    len(benchmark),
    "runs",
    benchmark["decomposition"].unique(),
...
# %%
df.to_csv(
    "/home/krupke/Repositories/tspn/dominiks_data_analysis/decomposition/decomposition_data.csv"
)
