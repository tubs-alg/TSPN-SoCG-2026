...
benchmark = Benchmark("results_optimality_gaps_900", hide_output=False)
...
def run_solve_with_order_pruning(_instance: AnnotatedInstance, alg_params: dict, **kwargs) -> dict:
...
alg_params_to_evaluate = [
    {"root": root, "search": "DfsBfs", "eps": eps}
    for eps in [0.001]
    for root in ["LongestEdgePlusFurthestSite", "OrderRoot"]
]

hard_instances = [
    "lagos_n060_seed7794",
    "random_mixed_square_n050_seed50006",
    "random_mixed_square_n060_seed60015",
    "random_mixed_square_n060_seed60006",
    "melbourne_n060_seed1685",
    "berlin_n050_seed7483",
    "tokyo_n060_seed53",
    "cape_town_n060_seed359",
    "dubai_n060_seed3351",
    "berlin_n060_seed2575",
    "warsaw_n060_seed4239",
    "mumbai_n060_seed926",
    "berlin_n060_seed6969",
    "osaka_n060_seed481",
    "vienna_n060_seed3619",
    "kuala_lumpur_n060_seed3530",
]
    ...
    with slurminade.JobBundling(max_size=2):
        with zipfile.ZipFile(db_path, "r") as zf:
            ...
            for instance_path in instance_files:
                if not any(inst in instance_path for inst in hard_instances):
                    continue
